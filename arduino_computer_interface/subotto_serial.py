...
class SubottoSerial:
    ...
    ASYNC_DESC = {SUB_PHOTO_RED_NORMAL: (1, 1, "Normal red photo", Event.EV_SOURCE_CELL_RED_PLAIN),
                  SUB_PHOTO_RED_SUPER: (1, 1, "Super red photo", Event.EV_SOURCE_CELL_RED_SUPER),
                  SUB_PHOTO_BLUE_NORMAL: (0, 1, "Normal blue photo", Event.EV_SOURCE_CELL_BLUE_PLAIN),
                  SUB_PHOTO_BLUE_SUPER: (0, 1, "Super blue photo", Event.EV_SOURCE_CELL_BLUE_SUPER),
